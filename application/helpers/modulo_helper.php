                  ...
                  <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                      <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                          <button class="col-md-4 btn btn-tpl" data-toggle="modal" data-target="#my_modal" onclick="get_niveles_atencion(<?php echo $row['id_modulo']; ?>)" href="#">Administrar niveles de acceso
                          </button>
                        </div>
