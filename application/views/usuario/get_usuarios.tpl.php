                            ...
                            <div class="col-lg-4">
                                <div class="input-group">
                                    <div class="input-group-btn">
                                        <button id="btn-filtro-tablero" type="button" class="btn btn-tpl dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Username <span class="caret"></span></button>
                                        <ul class="dropdown-menu">
                                            <li><a class="option-input-tablero" data-id="nombre_completo" href="#">Nombre</a></li>
                                            <li><a class="option-input-tablero" data-id="matricula" href="#">Username</a></li>
