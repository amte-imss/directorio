...
class Modulo extends MY_Controller
{
    ...
    public function index($full_view = 1, $modulo = null)
    {
        ...
        switch ($full_view)
        {
            ...
            case 2: //modal
                ...
                break;
            case 3: //modal niveles de acceso
    ...
    {        
        ...
        if ($this->input->is_ajax_request() && $this->input->post('modulo'))
        {
            ...
            $salida['tp_msg'] = $this->modulo->upsert_usuario($id_usuario, $this->input->post());
        }
    ...
    public function niveles_acceso()
    {
        if ($this->input->is_ajax_request() && $this->input->post('modulo'))
        {
            ...
            $salida['tp_msg'] = $this->modulo->upsert_niveles_acceso($niveles_acceso, $this->input->post());
            echo json_encode($salida);
        }
    }
