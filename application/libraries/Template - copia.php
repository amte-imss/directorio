...
class Template
{
    ...
    public function __construct()
    {
        ...
        $id_docente = 1;
//        if (!is_null($this->CI->session->userdata('id_docente'))) {
//            $id_docente = $this->CI->session->userdata('id_docente');
//        }
//        $this->set_datos_imagen_perfil($id_docente);
    }
     ...
     *      */
    public function set_Boton_cancelar($parametros = null, $tpl = 'ci_template/btn_cancelar_nueva_actividad')
    {
        if (is_null($parametros))
        {
            $parametros['titulo'] = 'Cancelar';
        }
     ...
     */
    public function set_boton_guardar($parametros = null, $tpl = 'ci_template/btn_guardar_editar_actividad')
    {
//        pr($parametros);
...
//        pr($this->element_seccion['boton_submit']);
     ...
     */
    public function set_comprobante($elementos_comprobante = null, $tpl = 'ci_template/formulario_carga_archivo')
    {
        if (!is_null($elementos_comprobante))
        {//Valida que exista el elemento comprobante
     ...
     */
    public function setBotonAgregarGeneral($parametros, $tpl = 'ci_template/btn_agregar_nueva_actividad', $ruta_accion_js = "assets/js/docente/template_docente.js")
    {
//        pr($parametros);
    ...
    public function setFormularioSecciones($elementos_seccion, $tpl = 'ci_template/secciones.tpl.php')
    {
...
//        pr($this->elementos_seccion['componente_comprobante']);
    ...
    {
        $vista_menu = $this->CI->load->view('ci_template/menu.tpl.php', $menu, TRUE);
     ...
     */
    function get_modal($tpl = 'ci_template/modal/modal_template')
    {
     ...
     *  )
     */
    function set_datos_imagen_perfil($id_docente)
    {
        $this->CI->load->model("Docente_model", "dm");
        /* Cargar imagen de perfil */
        $this->datos_imagen_perfil = $this->CI->dm->get_imagen_perfil($id_docente); //Obtener imagen del docente
//        pr($this->datos_imagen_perfil);
    }
