 ...
 * @param id html del elemento que contendrá los datos del resultado
 * @param función que se ejecutará cuando el ajax es correcto y se tienen datos
 * @param is_json para indicar que el resultado esperado es una cadena en formato json
 ...
 * @returns {undefined}
 */
function get_mensaje_general_modal(mensaje, tipo_mensaje, timeout) {
